...
<div class="main-connection-div" id="main-connection-div">
    ...
    <div class="register-main-connection-div" id="register-main-connection-div">
      ...
      <form >
        ...
        <div class="input-field col s6">
             <input type="text" name="lname" value="{{old('lname')}}" id="username intert-textarea" class="validate">
          ...
          <div class="input-field col s6">
             ...
             <input type="text" name="lemail" value="{{old('lemail')}}" id="username intert-textarea" class="validate">
          ...
          <div class="input-field col s6">
             <input type="password" name="lpass" value="{{old('lpass')}}" id="password intert-textarea" class="validate">
             <span class="text-danger">@error('lpass'){{$message}} @enderror  </span>

             <label for="password">Password</label>
          </div>
          <div class="input-field col s6">
             <input type="password" id="password intert-textarea" class="validate">
    ...
    <div class="log-in-main-connection-div" id="log-in-main-connection-div">
      <p class="title-log-in-main-connection-div">Sign In</p>
...
{{ csrf_field() }}
       ...
       <span class="remember-me-check">
        ...
        <label for="remember-me" style="margin: 0 0 0 8%; padding: 0 0 0 25px;">Remember me</label>
       </span>   
        </form>
